...
```sh
go get -u github.com/saveblush/gofiber3-swagger@v1.0.8
```
And import following in your code:

```go
import "github.com/saveblush/gofiber3-swagger" // swagger handler
```
...
import (
	...
	"github.com/saveblush/gofiber3-swagger"
